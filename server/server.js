...
app.get("/products/category/electronics",(req,res)=>{
    ...
    res.send(res.json(electronics));
})

app.get("/products/category/jewelery",(req,res)=>{
    const jewelery= products.filter(item =>{
        return item.category === 'jewelery';
    })
    res.send(res.json(jewelery));
})

app.get("/products/category/mens-clothing",(req,res)=>{
    const mensClothing= products.filter(item =>{
        return item.category === 'mens clothing';
    })
    res.send(res.json(mensClothing));
})

app.get("/products/category/womens-clothing",(req,res)=>{
    const womensClothing= products.filter(item =>{
        return item.category === 'womens clothing';
    })
    res.send(res.json(womensClothing));
})
